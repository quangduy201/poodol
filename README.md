<p align="center">
  <img src="assets/icons/icon.png" alt="Poodol icon" width="100">
</p>
<h1 align="center">Poodol</h1>

Poodol is a lightweight, cross-platform desktop wrapper for Facebook Messenger Web with more native features.
...
Poodol solves this by opening Messenger directly, providing a focused desktop chat experience similar to the old Messenger desktop app, while adding extra features.
...
**Poodol is an independent, unofficial open-source project and is not affiliated with Meta or Facebook**.
...
Poodol is licensed under the MIT License. See [LICENSE](LICENSE) for details.
